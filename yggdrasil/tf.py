"""Yggdrasil functions for running Terraform actions."""
import json
import os
import random
import string
...
from yggdrasil.data import terraform_vm_resource_name, supported_providers
from yggdrasil.specific.nutanix import get_vm_nutanix_uuid
...
def tf_generic(operation: Operation, tf_action):
    ...
    # It is useful for importing VMs created independently into Yggdrasil
    if tf_action == "import":
