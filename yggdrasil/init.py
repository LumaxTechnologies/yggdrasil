""" Initial operations needed for Yggdrasil """
import json
import os
import shutil
import subprocess
...
from yggdrasil.common_tools import load_yaml, j2, create_ssh_keys, merge_dictionaries, read_user_choice, get_credentials
from yggdrasil.data import available_infra_services, terraform_vm_resource_name, provider_secrets_helper, environment_name_mapping, custom_ssh_port_per_vm_type
from yggdrasil.specific.nutanix import get_vms_list_per_vlan_nutanix
from yggdrasil.specific.vsphere import get_vms_list_per_vlan_vsphere
from yggdrasil.specific.dns import *

def config_gitops(operation: Operation):

    """ this function executes the initial configuration of a Yggdrasil project folder
...
Let us configure some parameters for your Yggdrasil project folder."""
