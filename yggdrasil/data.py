...
If no, you will be prompted to provide your SSH password when executing Ansible without private SSH key access""",
    ...
    "aws": {
        ...
        "final_helper": "You are now done with setting your AWS credentials for Yggdrasil"
    },
    "azure": {
...
https://docs.microsoft.com/en-us/azure/virtual-machines/linux/terraform-install-configure""",
        "keys" : [],
        "final_helper": """Once you have set the files az_account.json and service_principal.json in secrets/azure folder you are ready to use Yggdrasil for Azure"""
    },
    "gcp": {
...
https://cloud.google.com/community/tutorials/getting-started-on-gcp-with-terraform.""",
        ...
        "final_helper": "You are now done with setting your GCP credentials for Yggdrasil"
    },
    "vsphere": {
        "templates": [".env.tpl"],
        ...
        "final_helper": "You are now done with setting your vSphere credentials for Yggdrasil"
    },
    "nutanix": {
        "templates": [".env.tpl"],
        ...
        "final_helper": "You are now done with setting your Nutanix credentials for Yggdrasil"
    },
}
