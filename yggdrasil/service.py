""" Yggdrasil functions for using Terraform with non-infrastructure services."""
import json
import os
import shutil
import yaml
...
from yggdrasil.common_tools import bash_action, j2
from yggdrasil.data import services_resources_mapping
from yggdrasil.specific.forti import ConfigParser
from yggdrasil.specific.parsing import FortiNetworking
    ...
    if service == "fortigate":
        ...
        for vdom_name, vdom in data_json.items():
            ...
            for resource_name, resource in  vdom.items():
                result[vdom_name][resource_name] = fortigate_parser.get_yggdrasil_format(resource_name, resource)
