...
Once you have defined this key, Yggdrasil convert it into an aggregated playbook located in `<PROJECT_ROOT>/scopes/<SCOPE>/inventory/execute_ansible.yml` by running the command :
